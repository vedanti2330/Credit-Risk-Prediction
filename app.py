   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "════════════════════════════════════════════════\n",
      "\n",
      "2025-10-27 16:17:14.959 No runtime found, using MemoryCacheStorageManager\n",
      "2025-10-27 16:17:14.972 No runtime found, using MemoryCacheStorageManager\n",
      "2025-10-27 16:17:15.694 \n",
      "  \u001b[33m\u001b[1mWarning:\u001b[0m to view this Streamlit app on a browser, run it with the following\n",
      "  command:\n",
      "\n",
      "    streamlit run C:\\Users\\vedan\\anaconda3\\Lib\\site-packages\\ipykernel_launcher.py [ARGUMENTS]\n",
      "2025-10-27 16:17:15.694 No runtime found, using MemoryCacheStorageManager\n",
      "2025-10-27 16:17:17.915 No runtime found, using MemoryCacheStorageManager\n"
     ]
    }
   ],
   "source": [
